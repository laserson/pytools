...
usearch_cmd = "%s --query %s --db %s --nofastalign --nousort --minlen 0 --maxaccepts 0 --maxrejects 0 --global --id 0 --userout %s --userfields query+target+id0+id1+id2+id3+id4+gaps+intgaps+qloz+qhiz+tloz+thiz+ql+tl+cols+intcols"
